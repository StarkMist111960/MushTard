...
MUSHM_URL="https://raw.githubusercontent.com/Jmoney46/MushTard/refs/heads/main/utils/MushTard.sh"
...
# curl -fsSLo "$MURK_DIR/mush/mushm.sh" "MUSHM_URL" || error "Failed to download MushTard"
